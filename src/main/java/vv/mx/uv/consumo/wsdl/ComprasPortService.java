 ...
 * 
 */
@WebServiceClient(name = "comprasPortService", targetNamespace = "t4is.uv.mx/compras", wsdlLocation = "http://localhost:8280/ws/compras.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8280/ws/compras.wsdl");
