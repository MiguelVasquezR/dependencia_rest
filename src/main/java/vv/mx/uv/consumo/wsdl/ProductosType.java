...
/**
 * <p>Clase Java para ProductosType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ProductosType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ProductosType", propOrder = {
    "producto"
})
public class ProductosType {

    @XmlElement(name = "Producto", required = true)
    protected List<ProductosType.Producto> producto;
     ...
     * {@link ProductosType.Producto }
     * 
     * 
     */
    public List<ProductosType.Producto> getProducto() {
        if (producto == null) {
            producto = new ArrayList<ProductosType.Producto>();
        }
