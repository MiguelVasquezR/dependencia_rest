 ...
 * 
 */
@WebServiceClient(name = "inventarioPortService", targetNamespace = "t4is.uv.mx/inventario", wsdlLocation = "https://inventarioserviciointegracion-production.up.railway.app/ws/inventario.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://inventarioserviciointegracion-production.up.railway.app/ws/inventario.wsdl");
