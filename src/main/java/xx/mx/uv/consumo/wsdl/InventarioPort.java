...
public interface InventarioPort {
    ...
    /**
     * 
     * @param obtenerFoliosRequest
     * @return
     *     returns xx.mx.uv.consumo.wsdl.ObtenerFoliosResponse
     */
    @WebMethod(operationName = "ObtenerFolios")
    @WebResult(name = "ObtenerFoliosResponse", targetNamespace = "t4is.uv.mx/inventario", partName = "ObtenerFoliosResponse")
    public ObtenerFoliosResponse obtenerFolios(
        @WebParam(name = "ObtenerFoliosRequest", targetNamespace = "t4is.uv.mx/inventario", partName = "ObtenerFoliosRequest")
        ObtenerFoliosRequest obtenerFoliosRequest);

    /**
     * 
     * @param validarFolioRequest
     * @return
     *     returns xx.mx.uv.consumo.wsdl.ValidarFolioResponse
     */
